...
function drawDoughnutChart(data, color_set) {
    ...
    var margin = {top: 50, right: 30, bottom: 40, left: 0};
...
function drawBarLegend() {
    var legend_bar = d3.select("#bar-growth").append("div")
                                      .style("position", "absolute")
                                      .style("top", "25px")
                                      .style("right", "-110px");

    table = legend_bar.append('table')
...
function drawBarChart(data) {
    ...
    var rect = g.selectAll("rect")
                ...
                .attr("y", function(d) {
                            ...
                            if (d.label === "local_population_growth") {
                                return (y("Natural") + y("Domestic Migratory")) / 2 - height/ 2 + margin.top - 5;
                            }

                            if (["Births", "Deaths", "natural_increase"].indexOf(d.label) !== -1) {
                                posit_y = y("Natural")  + margin.top - 15;
                            } else {
                                posit_y = y("Domestic Migratory") + margin.top - 15;
                            }
