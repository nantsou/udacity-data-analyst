...
### check the max and min value of exercised_stock_options and salary
ex_stok = []
salary = []
for users in data_dict:
    val_1 = data_dict[users]["exercised_stock_options"]
    if val_1 == 'NaN':
        continue
    ex_stok.append(val_1)
    val_2 = data_dict[users]["salary"]
    if val_2 == 'NaN':
        continue
    salary.append(val_2)
print max(ex_stok)
